...
All experiments were run on a Dell Opteron TK with Xeon TK. Unless
otherwise noted multiple processes were run in parallel, and times
reported were not averaged over multiple runs. Since we saw
significant variation of up to 10%, the times should be taken with a
grain of salt.
...
** Gold Indpendent Span Boundaries
...
#+attr_latex: :center nil
| SentLen | time(s) |   #edges |                      |   F_1 |       | #failed |
|---------+---------+----------+----------------------+-------+-------+---------|
|       0 |  1016.8 | 8.47e+09 | \hspace{-1em} (48%)  | 86.71 | +0.86 |       4 |
|      20 |  1054.6 | 8.90e+09 | \hspace{-1em} (51%)  | 86.55 | +0.70 |       2 |
|      30 |  1152.9 | 1.08e+10 | \hspace{-1em} (62%)  | 86.33 | +0.48 |       0 |
|      40 |  1344.4 | 1.39e+10 | \hspace{-1em} (79%)  | 86.04 | +0.19 |       0 |
|---------+---------+----------+----------------------+-------+-------+---------|
|       ∞ |  1292.9 | 1.75e+10 | \hspace{-1em} (100%) | 85.85 |       |       0 |
